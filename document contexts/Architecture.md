...
Sudah ada di live checkout: `.docs/ROADMAP.md`, `.docs/TECHNICAL-DEBT.md`, phase plan,
...
| `.docs/MODULAR-MIGRATION-LEDGER.md`        | Dibuat pada Phase 00; status row awal masih harus diverifikasi per vertical module |
...
4. `.docs/ROADMAP.md`, active phase plan, QA report, dan technical debt.
